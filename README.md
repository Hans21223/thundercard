...
- Upload your own flag. Hover the vehicle picture on the card for a Photoshop-style transform box: drag to move, corners scale (Shift: freely), sides stretch.
...
- **Auto-save** (Settings): edits go into the Library save you opened, or into the Library's Autosave folder.
- In your own tree, a vehicle moved into a premium column becomes premium, and one moved out becomes a normal researchable vehicle.
